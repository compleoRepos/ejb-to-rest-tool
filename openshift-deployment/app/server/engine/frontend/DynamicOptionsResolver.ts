...
const DOMAIN_INDICATORS: Record<IndustryStandard, { keywords: string[]; classPatterns: RegExp[]; label: string }> = {
  BIAN: {
    keywords: [
      ...
      "cheque", "remittance", "treasury", "custody", "securities",
      "trade", "syndication", "factoring", "leasing", "guarantee",
      "overdraft", "standing_order", "direct_debit", "card", "atm",
      "branch", "teller", "correspondent", "nostro", "vostro",
      "maturity", "amortization", "disbursement", "drawdown",
      "virement", "compte", "solde", "pret", "echeance", "epargne",
      "placement", "titre", "obligation", "action", "opcvm", "sicav",
      "bourse", "cotation", "dividende", "coupon", "rendement",
      "caution", "nantissement", "hypotheque", "gage", "surete",
    ],
    classPatterns: [
  ...
  ACORD: {
    keywords: [
      ...
      "franchise", "indemnisation", "expertise", "recours", "avenant",
      "souscription", "tarification", "courtier", "agent", "intermediaire",
      "quittance", "prime", "mutuelle", "prevoyance", "solvabilite",
      "automobile", "habitation", "multirisque", "responsabilite_civile",
      "deces", "rente", "epargne", "rachat", "capitalisation",
      "catastrophe", "dommage", "incendie", "vol", "bris_de_glace",
    ],
    classPatterns: [
  ...
  HL7_FHIR: {
    keywords: [
      ...
      "vaccination", "imagerie", "radiologie", "scanner", "irm",
      "chirurgie", "bloc", "anesthesie", "urgence", "reanimation",
      "biologie", "prelevement", "analyse", "resultat", "constante",
      "dossier_medical", "dmp", "carte_vitale", "rpps", "finess",
      "cim10", "ccam", "ngap", "t2a", "ghs", "pmsi",
      "consentement", "parcours_soin", "protocole", "plan_soin",
    ],
    classPatterns: [
  ...
  TMFORUM: {
    keywords: [
      ...
      "fibre", "adsl", "4g", "5g", "lte", "ftth", "dslam",
      "msisdn", "imsi", "imei", "mvno", "olt", "nra",
      "forfait", "prepaye", "postpaye", "recharge", "top_up",
      "portabilite", "resiliation", "migration", "raccordement",
      "debit", "bande_passante", "qos", "latence", "jitter",
      "antenne", "relais", "couverture", "cellule", "frequence",
    ],
    classPatterns: [
  ...
  DDD: {
    keywords: [
      ...
      "sku", "variante", "categorie", "prix", "promotion",
      "livraison", "expedition", "colis", "tracking", "retour",
      "remboursement", "avoir", "fidelite", "points", "cashback",
      "vendeur", "seller", "marchand", "commission", "plateforme",
      "stock", "inventaire", "entrepot", "warehouse", "reappro",
      "avis", "notation", "comparaison", "recherche", "filtre",
    ],
    classPatterns: [
  ...
  TOGAF: {
    keywords: [
      ...
      "bpmn", "camunda", "activiti", "esb", "kafka", "rabbitmq",
      "keycloak", "saml", "jwt", "api_gateway", "kong", "apigee",
      "elasticsearch", "solr", "redis", "cache", "cqrs",
      "event_sourcing", "saga", "microservice", "service_mesh",
      "prometheus", "grafana", "elk", "apm", "observabilite",
      "alfresco", "nuxeo", "ged", "archivage", "cmis",
      "quartz", "spring_batch", "scheduler", "cron", "job",
    ],
    classPatterns: [
