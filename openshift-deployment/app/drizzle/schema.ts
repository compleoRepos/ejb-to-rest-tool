...
export const projects = mysqlTable("projects", {
  ...
  defaultBranch: varchar("defaultBranch", { length: 100 }),
  isArchived: boolean("isArchived").default(false),
  isFork: boolean("isFork").default(false),
