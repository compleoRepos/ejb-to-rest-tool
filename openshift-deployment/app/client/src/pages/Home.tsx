  ...
  return (
    <ScrollArea className="h-full">
      <div className="p-6 max-w-6xl mx-auto space-y-8">
        ...
        >
          <StatCard icon={FolderGit2} label="Projets" value={stats?.totalProjects ?? 0} color="text-primary" testId="project-count" />
          <StatCard icon={FileCode2} label="Fichiers" value={stats?.totalFiles ?? 0} color="text-emerald-400" testId="file-count" />
          <StatCard icon={Code2} label="Lignes de code" value={stats?.totalLines ?? 0} color="text-amber-400" testId="lines-count" />
          <StatCard icon={Layers} label="Technologies" value={stats?.totalTechnologies ?? 0} color="text-cyan-400" testId="tech-count" />
        </motion.div>
